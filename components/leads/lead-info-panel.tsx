...
/* ------------------------------------------------------------------ */
/*  Lead Info Panel — inline resizable panel for lead editing            */
/* ------------------------------------------------------------------ */
...
export function LeadInfoPanel({ lead, onClose }: LeadInfoPanelProps) {
  ...
  }, [lead.id, hasDirtyFields, formData, dirtyFields, hydrateLeads])
