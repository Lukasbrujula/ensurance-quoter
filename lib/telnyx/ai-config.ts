...
export function buildInsuranceAssistantConfig(
  ...
  const config: TelnyxAssistantCreateDto = {
    ...
    greeting: `Hi, you've reached ${agentName}'s office. I'm a digital assistant helping with calls today. They're not available right now, but I can take some information so they can call you back. Just so you know, this call may be recorded and transcribed for quality purposes. How can I help?`,
    transcription: {
      model: "deepgram/flux",
      language: "en",
    },
