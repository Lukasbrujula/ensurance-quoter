...
<div id="companies">
	    ...
	    <div id="landing">
<?php 
$logos = file_get_contents("https://www.compulifeapi.com/api/CompanyLogoListCanada/small");
echo '<script> var logos = '. $logos . '; </script>';
?>
  <p id="logos"></p> 
<input type="hidden" name="requestType" value="results">      
      
	  <span class="text-element text-1">Province<br></span>
...
<option value="9" selected="selected">Ontario</option>
...
<option value="A">Level Term to age 65</option>
<option value="B">Level Term to age 70</option>
<option value="C">Level Term to age 75</option>
<option value="W">Level Term to age 80</option>
<option value="F">Other Term</option>
<option value="Z:357">10, 20, 30 Year Term</option>
<option value="Z:13456790ABCW">All Level Term Product Categories</option>
<option value="G">Decreasing Term</option>
<option value="H">Whole Life Guaranteed Life Pay</option>
<option value="I">Whole Life Guaranteed Pay to 65</option>
<option value="T">Whole Life Guaranteed 25 Pay</option>
...
<option value="L">U/L T100 - Minimum Premium</option>
<option value="M">U/L T100 - Minimum Premium - 20 Pay</option>
<option value="N">U/L-T100 - Minimum Premium - 15 Pay</option>
<option value="O">U/L-T100 - Minimum Premium - 10 Pay</option>
...
<!-- <input type="hidden" name="COMPINC" value="BMOL,CANA"> -->
<!-- <input type="hidden" name="PRODDIS" value="5AMES,5CCNS"> -->
